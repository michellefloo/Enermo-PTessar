...
const UserManagement = React.lazy(() =>
  import("./views/user-management/UserManagement")
);
...
const DeviceInstallation = React.lazy(() =>
  import("./views/device-installation/DeviceInstallation")
);
const DeviceHistory = React.lazy(() => import("./views/device-history/"));
const DeviceGroup = React.lazy(() =>
  import("./views/device-group/DeviceGroup")
);
const Customer = React.lazy(() => import("./views/customers/Customer"));
const Settings = React.lazy(() => import("./views/settings/Settings"));
const DeviceHistoryChart = React.lazy(() =>
  import("./views/device-history-chart/")
);
const DeviceSummaryTable = React.lazy(() =>
  import("./views/device-summary-table/")
);
...
const routes = [
  ...
  {
    path: "/boundary/list",
    name: "Boundaries / Boundary List",
    component: BoundaryList,
  },
  {
    path: "/utility/list",
    name: "Utilities / Utility List",

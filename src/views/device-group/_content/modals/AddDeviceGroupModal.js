...
const DeviceGroupAddModal = () => {
    ...
    const mutationAddDeviceGroup= useAddDeviceGroup((oldData, newData) => [...oldData, newData], initialValues.id_group)
    ...
    const UserModalForm = forwardRef((_, ref) => {
        const formik = useFormik({
            ...
            onSubmit: async (values) => {
                setSubmitting(true)
                // console.log("=============================")
                // console.log(deviceTableRef)
                const copyOfValues = {...values}
                try {
                    await mutationAddDeviceGroup.mutateAsync(values)
                    .then((res) => {
                        // console.log(res)
        ...
        return(
            <CForm>
                ...
                {/* <CFormGroup row>
                    ...
                    <CCol xs="12" md="12">
                      <DeviceDatable ref={deviceTableRef}/>    
                    </CCol>
                </CFormGroup>  */}
            </CForm>
        )

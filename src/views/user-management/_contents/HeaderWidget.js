...
import { useGetUserManagementUsersAllCount, 
...
const UserManegementHeaderCounter = () => {
    ...
    const {data: rqDataUserManAllCount, status: rqStatusUserManAllCount} = useGetUserManagementUsersAllCount(0)
    const {data: rqDataUserManLockCount, status: rqStatusUserManLockCount} = useGetUserManagementUsersLockCount(0)
    const {data: rqDataUserManUnverifiedCount, status: rqStatusUserManUnverifiedCount} = useGetUserManagementUnverifiedCount(0)
    
    if(rqStatusUserManAllCount === 'loading' || 
        rqStatusUserManLockCount === 'loading' ||
         rqStatusUserManUnverifiedCount === 'loading'
    ){
        return <CCol xs="12" sm="6" lg="4">
           ...
           <CCol xs="12" sm="6" lg="4">
            ...
            <CCol xs="12" sm="6" lg="4">
                <CWidgetIcon 
                    ...
                    text="Locked User(s)" color="warning"
                >
            ...
            <CCol xs="12" sm="6" lg="4">
                <CWidgetIcon 
                    ...
                    text="Unverified User(s)" color="danger" 
                >
